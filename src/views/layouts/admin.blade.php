...
<head>
    ...
    <link href="{{ asset('vendor/crudgenerator/css/custom.css') }}" rel="stylesheet" />
    @yield('styles')
</head>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    ...
    <div class="app-body">
        @include('CRUDGENERATOR::partials.menu')
        <main class="main">
    ...
    <script src="{{ asset('vendor/crudgenerator/js/main.js') }}"></script>
    <script>
        $(function() {
